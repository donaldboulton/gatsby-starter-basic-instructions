...
import { RiArrowLeftSLine, RiSkullLine, RiBugLine } from 'react-icons/ri'
...
const NotFound = () => (
  <>
    ...
    <Layout className="not-found-page">
      <Seo type="page" title="404" description="Not Found" />
      <div
        className="wrapper"
        style={{
          textAlign: 'center',
    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          '@type': 'WebPage',
          name: '404 Not Found',
          url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/404',
          image: {
            '@type': 'ImageObject',
            url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/static/assets/blood.jpg',
            width: '1400',
        ...
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              '@type': 'ListItem',
              item: {
                '@id': 'https://gatsbystarterbasicinstructions.gatsbyjs.io/404',
                name: 'NotFound',
              },
              position: '2',
            },
