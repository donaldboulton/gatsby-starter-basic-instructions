    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          audience: 'public',
          abstract:
            'PubliusLogic has Topics on Creation, Law, USA and World Governments, Life Matters. Our Main focus is the Re-Creation of Mankind to the Spiritual Beings you have forgotten tags, as you only live in the Flesh. Your Soul and Spirit you deny.',
          author: {
          ...
          image: {
            '@type': 'ImageObject',
            url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/static/assets/tags.jpg',
            width: '1400',
            height: '450',
          },
          inLanguage: 'en',
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          '@type': 'WebPage',
          name: 'tags Not Found',
          url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/tags',
          image: {
            '@type': 'ImageObject',
            url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/static/assets/tags.jpg',
            width: '1400',
