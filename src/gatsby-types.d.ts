...
type FileFieldsEnum =
  ...
  | 'childMarkdownRemark.frontmatter.cta.ctaLink'
  | 'childMarkdownRemark.frontmatter.cta.ctaText'
  ...
  | 'childrenMarkdownRemark.frontmatter.cta.ctaLink'
  | 'childrenMarkdownRemark.frontmatter.cta.ctaText'
...
type Frontmatter = {
  ...
  readonly cta: Maybe<MarkdownRemarkFrontmatterCta>;
...
type FrontmatterFilterInput = {
  ...
  readonly cta: InputMaybe<MarkdownRemarkFrontmatterCtaFilterInput>;
...
type MarkdownRemarkFrontmatterCta = {
  readonly ctaLink: Maybe<Scalars['String']>;
  readonly ctaText: Maybe<Scalars['String']>;
};

type MarkdownRemarkFrontmatterCtaFilterInput = {
...
type Query_allSiteSearchIndexArgs = {
  ...
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<SiteSearchIndexSortInput>;
};
...
type SiteSearchIndexFieldsEnum =
  | 'children'
  | 'children.children'
  | 'children.children.children'
  | 'children.children.children.children'
...
type SiteSearchIndexSortInput = {
  readonly fields: InputMaybe<ReadonlyArray<InputMaybe<SiteSearchIndexFieldsEnum>>>;
  readonly order: InputMaybe<ReadonlyArray<InputMaybe<SortOrderEnum>>>;
};
...
type AboutQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type AboutQueryQuery = { readonly markdownRemark: { readonly id: string, readonly htmlAst: Record<string, unknown> | null, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly path: string | null, readonly description: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };
...
type blogListQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly excerpt: string | null, readonly timeToRead: number | null, readonly frontmatter: { readonly date: string | null, readonly path: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly description: string | null, readonly category: string | null, readonly title: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> } };
...
type BlogPostQueryQuery = { readonly markdownRemark: { readonly id: string, readonly htmlAst: Record<string, unknown> | null, readonly excerpt: string | null, readonly timeToRead: number | null, readonly tableOfContents: string | null, readonly frontmatter: { readonly date: string | null, readonly path: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly category: string | null, readonly title: string | null, readonly description: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type ContactQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type ContactQueryQuery = { readonly markdownRemark: { readonly id: string, readonly html: string | null, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly path: string | null, readonly description: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null, readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null };
...
type HomeQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type HomeQueryQuery = { readonly markdownRemark: { readonly id: string, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly titleAlt: string | null, readonly tagline: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly cta: { readonly ctaText: string | null, readonly ctaLink: string | null } | null } | null } | null, readonly posts: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly date: string | null, readonly path: string | null, readonly title: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> }, readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null };

type PrivacyQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type PrivacyQueryQuery = { readonly markdownRemark: { readonly id: string, readonly htmlAst: Record<string, unknown> | null, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly path: string | null, readonly description: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type SearchIndexQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SearchIndexQueryQuery = { readonly siteSearchIndex: { readonly index: any | null } | null };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly excerpt: string | null, readonly fields: { readonly slug: string | null } | null, readonly headings: ReadonlyArray<{ readonly depth: number | null, readonly value: string | null } | null> | null, readonly frontmatter: { readonly path: string | null, readonly template: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly category: string | null, readonly title: string | null, readonly description: string | null } | null } }> }, readonly tagsGroup: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null }> }, readonly categoryGroup: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null }> } };
