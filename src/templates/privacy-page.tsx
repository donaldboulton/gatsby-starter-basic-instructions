    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          audience: 'public',
          abstract:
            'PubliusLogic has Topics on Creation, Law, USA and World Governments, Life Matters. Our Main focus is the Re-Creation of Mankind to the Spiritual Beings you have forgotten privacy, as you only live in the Flesh. Your Soul and Spirit you deny.',
          author: {
          ...
          image: {
            '@type': 'ImageObject',
            url: 'https://gatsbystarterbasicinstructions.gatsbyjs.io/static/assets/privacy.jpg',
            width: '1400',
            height: '450',
          },
          inLanguage: 'en',
